...
+ Syntax :: class /classname/ &rest /slot-description*/
     
            structure /classname/ &rest /slot-description*/
+ /classname/ :: One of the following:
  + A symbol naming a class (including =standard-class=, =structure-class= and =built-in-class=. =find-class= should return a class)
  + A symbol, where a symbol /<classname>-p/ in the same package is fbound. It should be a unary function (or the consequence is undefined)
  + A symbol, where a symbol /<classname>p/ in the same package is fbound. It should be a unary function (or the consequence is undefined)
+ /slot-description/ :: one of the following:
  + make-instance style plist :: /keyword subpattern/
  + with-slots style :: /(slot-name subpattern)/
  + with-accessors style :: /(accessor-name subpattern)/ . Where =accessor-name= is one of:
    + An arbitrary fbound symbol.
    + A symbol of name /class-name/-/accessor-name/
    + A symbol of name /class-name//accessor-name/
