...
+ Gomoku :: Matches a set of randomly generated 5x5 fields of [[Gomoku table game][https://en.wikipedia.org/wiki/Gomoku]] against the /winning patterns/ of the game, in order to determine if a Black player is winning, or a White player is winning. 100000 fields are generated and fixed, then supplied to each matcher.
