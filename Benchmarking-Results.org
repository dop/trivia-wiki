...
Test Domains are partly picked from (Emilie 2006). Source code of these domains is available @ [[https://github.com/guicho271828/trivia/blob/master/bench/definitions.lisp][bench/definisitons.lisp]] . 
