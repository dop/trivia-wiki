...
+ level 1 : core patterns :: =match1= supports =or1= and =guard1= patterns
     ...
     =if= forms.
+ level 2a : pattern expander :: Provides several wrapper macros over
     =match1=. All derived patterns are expanded into level1 patterns,
     including the primitive patterns in Optima.
